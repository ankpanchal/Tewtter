...
/**
 * Servlet implementation class RecentMessage
 */
@WebServlet("/RecentMessage")
public class RecentMessage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Tewtterrrr mess = messageList.get(0);
		request.setAttribute("flag", true);
		request.setAttribute("messageList", mess);
		getServletContext().getRequestDispatcher("/recentmessage.jsp").forward(request, response);
